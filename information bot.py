...
def shut_down():
    p1 = Thread(target=speak, args=(
        "Shutting down. Thankyou For Using Our Sevice. Take Care, Good Bye.",))
    p1.start()
...
def web_scraping(qs):
    ...
    canvas2.create_text(10, 225, anchor=NW, text=answer, font=(
...
def wishme():
    ...
    if 0 <= hour < 12:
        text = "Good Morning sir. I am meme. How can I Serve you?"
    elif 12 <= hour < 18:
        text = "Good Afternoon sir. I am meme. How can I Serve you?"
    else:
        text = "Good Evening sir. I am meme. How can I Serve you?"

    canvas2.create_text(10, 10, anchor=NW, text=text, font=(
        'Candara Light', -25, 'bold italic'), fill="white", width=350)
...
if __name__ == "__main__":
    ...
    frames = [PhotoImage(file='giphy3.gif', format='gif -index %i' % (i))
              for i in range(40)]
    ...
    canvas2 = Canvas(frame, bg='#a69a9a', width=500,
                     height=596, scrollregion=(0, 0, 500, 900))
...
# unit 1 intro with flow chart
# unit 2 to 4 software
# unit 5 hardware
# 15 to 20 ref
# Information bot
